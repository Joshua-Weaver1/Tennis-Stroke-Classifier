...
class TestRandomForestModel(unittest.TestCase):
    ...
    def test_create_windows(self):
        ...
        y = [0, 1, 0, 1, 0]
        window_size = 3
        X_windows, y_windows = random_forest_model.create_windows(X, y, window_size)
    ...
    def test_calculate_metrics(self):
        ...
        print("Testing Results For Random Forest")
        accuracy, recall, precision, f1_score, correct_guesses, total_guesses = random_forest_model.calculate_metrics("data/all_shot_data.csv")
    ...
    def test_calculate_metrics_score(self):
        ...
        print("Evaluating Results For Random Forest")
        accuracy, recall, precision, f1_score, correct_guesses, total_guesses = random_forest_model.calculate_metrics("data/all_shot_data.csv")
